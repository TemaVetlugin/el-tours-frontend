...
export const PHomeCatalogProductsPopular = observer(({ catalogProducts }: PropsType) => {
    const contentResource = useContentResource('home.catalog-products-popular');
                    ...
                    if (index === 2 && contentResource) {
                        return (
                            <div
                                ...
                                className={'p-home-catalog-products-popular__content-resource'}
                                style={{
