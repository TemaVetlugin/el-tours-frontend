...
export class PaginationModel extends Model<PaginationModelInterface> implements PaginationModelInterface {
    fillable: Array<keyof PaginationModelInterface> = [
        "page",
        "total",
        "pages"
    ];
    ...
    constructor(payload?: PaginationModelInterface) {
        super();
